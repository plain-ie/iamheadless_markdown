...
class Bold(BaseWidget):
    name = 'bold'
    patterns = [r'(\*\*\*([^\*]+)\*\*\*)']
    template = 'iamheadless_markdown/widgets/bold.html'
...
class HeadingH1(BaseWidget):
    name = 'heading_h1'
    patterns = [r'^\#\s?[^#]+$']
    template = 'iamheadless_markdown/widgets/heading_h1.html'
...
class HeadingH2(BaseWidget):
    name = 'heading_h2'
    patterns = [r'^\#\#\s?[^#]+$']
    template = 'iamheadless_markdown/widgets/heading_h2.html'
...
class HeadingH3(BaseWidget):
    name = 'heading_h3'
    patterns = [r'^\#\#\#\s?[^#]+$']
    template = 'iamheadless_markdown/widgets/heading_h3.html'
...
class HeadingH4(BaseWidget):
    name = 'heading_h4'
    patterns = [r'^\#\#\#\#\s?[^#]+$']
    template = 'iamheadless_markdown/widgets/heading_h4.html'
...
class HorizontalRule(BaseWidget):
    ...
    patterns = [r'^\*\*\*$']
    template = 'iamheadless_markdown/widgets/horizontal_rule.html'
...
class Image(BaseWidget):
    name = 'link'
    patterns = [r'^\!(\[([^\`\]]+)\]\(([^\)\"]+)\s?(\"([^\"]+)\")?\s?\))$']
    template = 'iamheadless_markdown/widgets/image.html'
...
class CallToActionLink(BaseWidget):
    ...
    template = 'iamheadless_markdown/widgets/call_to_action_link.html'
...
class Link(BaseWidget):
    name = 'link'
    patterns = [r'(\[([^\`\]]+)\]\(([^\)]+)\))']
    template = 'iamheadless_markdown/widgets/link.html'
...
class OrderedListElement(BaseWidget):
    ...
    patterns = [r'^[\d]+\.\s?.+$']
    template = 'iamheadless_markdown/widgets/list_element.html'
...
class Paragraph(BaseWidget):
    name = 'paragraph'
    patterns = [r'^.*$']
    template = 'iamheadless_markdown/widgets/paragraph.html'
